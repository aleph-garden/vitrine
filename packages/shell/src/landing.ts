...
import type { View } from '@aleph-garden/view'
...
const HTML = `<section class="landing">
  ...
  <p><a href="/docs/view/" target="_top">Read about view</a> · <a href="https://github.com/aleph-garden/vocab" target="_top">The vocabularies</a></p>
</section>`
