...
`text/html` representation of every resource. The same shell runs at
`https://aleph.garden/`, where it renders its own landing view and opens any
IRI written after the origin.
