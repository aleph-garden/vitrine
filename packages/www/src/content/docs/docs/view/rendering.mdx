...
view's own writes in `hydrate` are the view's, and that is why the Markdown
view stays off aleph.garden until the sandboxed region exists. [Foreign
content](/docs/view/hosts/#foreign-content) has the rest of the reasoning.
